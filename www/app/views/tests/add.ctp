...
echo $form->inputs(array('legend' => 'Add Test',
						...
						'units'=>array('label'=>'Units','after'=>'<br/><em>Optional. What are the units of this test?</em>'),
						...
						'lower_limit'=>array('label' => 'Lower Normal Limit',
											'after'=> '<br/><em>Optional. What is the lower normal limit of the test value?</em>'),
